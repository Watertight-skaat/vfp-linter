...
// test/run-ast-tests.ts re-derives the node names and property names from foxpro.pegjs and asserts they match this file exactly, so the two cannot drift apart silently.
