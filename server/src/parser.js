...
function peg$parse(input, options) {
  ...
  const peg$c83 = "insert";
  const peg$c84 = "values";
  const peg$c85 = "memvar";
  const peg$c86 = "name";
  const peg$c87 = "for";
  const peg$c88 = "step";
  const peg$c89 = "endfor";
  const peg$c90 = "next";
  const peg$c91 = "do while";
  const peg$c92 = "enddo";
  const peg$c93 = "exit";
  const peg$c94 = "loop";
  const peg$c95 = "create";
  const peg$c96 = "table";
  const peg$c97 = "free";
  const peg$c98 = "codepage";
  const peg$c99 = "null";
  const peg$c100 = "check";
  const peg$c101 = "error";
  const peg$c102 = "autoinc";
  const peg$c103 = "nextvalue";
  const peg$c104 = "default";
  const peg$c105 = "primary";
  const peg$c106 = "key";
  const peg$c107 = "unique";
  const peg$c108 = "collate";
  const peg$c109 = "references";
  const peg$c110 = "tag";
  const peg$c111 = "nocptrans";
  const peg$c112 = "foreign";
  const peg$c113 = "nodup";
  const peg$c114 = "try";
  const peg$c115 = "catch";
  const peg$c116 = "when";
  const peg$c117 = "throw";
  const peg$c118 = "finally";
  const peg$c119 = "endtry";
  const peg$c120 = "set";
  const peg$c121 = "additive";
  const peg$c122 = "off";
  const peg$c123 = "append";
  const peg$c124 = "blank";
  const peg$c125 = "nomenu";
  const peg$c126 = "replace";
  const peg$c127 = "while";
  const peg$c128 = "nooptimize";
  const peg$c129 = "store";
  const peg$c130 = "[";
  const peg$c131 = "]";
  const peg$c132 = "todo";
  const peg$c133 = "return";
  const peg$c134 = "procedure";
  const peg$c135 = "function";
  const peg$c136 = "endproc";
  const peg$c137 = "endfunc";
  const peg$c138 = "class";
  const peg$c139 = "quit";
  const peg$c140 = "$";
  const peg$c141 = "\"";
  const peg$c142 = "'";
  ...
  const peg$e96 = peg$literalExpectation("INSERT", true);
  const peg$e97 = peg$literalExpectation("VALUES", true);
  const peg$e98 = peg$literalExpectation("MEMVAR", true);
  const peg$e99 = peg$literalExpectation("NAME", true);
  const peg$e100 = peg$literalExpectation("FOR", true);
  const peg$e101 = peg$literalExpectation("STEP", true);
  const peg$e102 = peg$literalExpectation("ENDFOR", true);
  const peg$e103 = peg$literalExpectation("NEXT", true);
  const peg$e104 = peg$literalExpectation("DO WHILE", true);
  const peg$e105 = peg$literalExpectation("ENDDO", true);
  const peg$e106 = peg$literalExpectation("EXIT", true);
  const peg$e107 = peg$literalExpectation("LOOP", true);
  const peg$e108 = peg$literalExpectation("CREATE", true);
  const peg$e109 = peg$literalExpectation("TABLE", true);
  const peg$e110 = peg$literalExpectation("FREE", true);
  const peg$e111 = peg$literalExpectation("CODEPAGE", true);
  const peg$e112 = peg$literalExpectation("NULL", true);
  const peg$e113 = peg$literalExpectation("CHECK", true);
  const peg$e114 = peg$literalExpectation("ERROR", true);
  const peg$e115 = peg$literalExpectation("AUTOINC", true);
  const peg$e116 = peg$literalExpectation("NEXTVALUE", true);
  const peg$e117 = peg$literalExpectation("DEFAULT", true);
  const peg$e118 = peg$literalExpectation("PRIMARY", true);
  const peg$e119 = peg$literalExpectation("KEY", true);
  const peg$e120 = peg$literalExpectation("UNIQUE", true);
  const peg$e121 = peg$literalExpectation("COLLATE", true);
  const peg$e122 = peg$literalExpectation("REFERENCES", true);
  const peg$e123 = peg$literalExpectation("TAG", true);
  const peg$e124 = peg$literalExpectation("NOCPTRANS", true);
  const peg$e125 = peg$classExpectation([["A", "Z"], ["a", "z"]], false, false, false);
  const peg$e126 = peg$literalExpectation("FOREIGN", true);
  const peg$e127 = peg$literalExpectation("NODUP", true);
  const peg$e128 = peg$otherExpectation("try-catch statement");
  const peg$e129 = peg$literalExpectation("TRY", true);
  const peg$e130 = peg$literalExpectation("CATCH", true);
  const peg$e131 = peg$literalExpectation("WHEN", true);
  const peg$e132 = peg$literalExpectation("THROW", true);
  const peg$e133 = peg$literalExpectation("FINALLY", true);
  const peg$e134 = peg$literalExpectation("ENDTRY", true);
  const peg$e135 = peg$literalExpectation("SET", true);
  const peg$e136 = peg$literalExpectation("ADDITIVE", true);
  const peg$e137 = peg$literalExpectation("OFF", true);
  const peg$e138 = peg$literalExpectation("APPEND", true);
  const peg$e139 = peg$literalExpectation("BLANK", true);
  const peg$e140 = peg$literalExpectation("NOMENU", true);
  const peg$e141 = peg$literalExpectation("REPLACE", true);
  const peg$e142 = peg$literalExpectation("WHILE", true);
  const peg$e143 = peg$literalExpectation("NOOPTIMIZE", true);
  const peg$e144 = peg$literalExpectation("STORE", true);
  const peg$e145 = peg$literalExpectation("[", false);
  const peg$e146 = peg$literalExpectation("]", false);
  const peg$e147 = peg$otherExpectation("procedure");
  const peg$e148 = peg$literalExpectation("TODO", true);
  const peg$e149 = peg$literalExpectation("RETURN", true);
  const peg$e150 = peg$otherExpectation("keyword");
  const peg$e151 = peg$literalExpectation("PROCEDURE", true);
  const peg$e152 = peg$literalExpectation("FUNCTION", true);
  const peg$e153 = peg$literalExpectation("ENDPROC", true);
  const peg$e154 = peg$literalExpectation("ENDFUNC", true);
  const peg$e155 = peg$literalExpectation("DEFINE", true);
  const peg$e156 = peg$literalExpectation("INCLUDE", true);
  const peg$e157 = peg$literalExpectation("CLASS", true);
  const peg$e158 = peg$literalExpectation("QUIT", true);
  const peg$e159 = peg$otherExpectation("number");
  const peg$e160 = peg$literalExpectation("$", false);
  const peg$e161 = peg$otherExpectation("string");
  ...
  const peg$e167 = peg$otherExpectation("end of line");
  const peg$e168 = peg$literalExpectation("\n", false);
  const peg$e169 = peg$literalExpectation("\r\n", false);
  const peg$e170 = peg$classExpectation(["\r", ["\u2028", "\u2029"]], false, false, false);
  const peg$e171 = peg$otherExpectation("boolean");
  const peg$e172 = peg$literalExpectation(".T.", true);
  const peg$e173 = peg$literalExpectation(".F.", true);
  const peg$e174 = peg$literalExpectation("TRUE", true);
  const peg$e175 = peg$literalExpectation("FALSE", true);
  const peg$e176 = peg$otherExpectation("null");
  const peg$e177 = peg$literalExpectation(".NULL.", true);
  const peg$e178 = peg$otherExpectation("semicolon");
  const peg$e179 = peg$literalExpectation(";", false);
  const peg$e180 = peg$classExpectation([" ", "\t"], false, false, false);
  const peg$e181 = peg$otherExpectation("whitespace");
  const peg$e182 = peg$classExpectation([" ", "\t", "\f", "\v"], false, false, false);
  const peg$e183 = peg$otherExpectation("empty line");
  const peg$e184 = peg$otherExpectation("comment");
  const peg$e185 = peg$otherExpectation("single-line comment");
  const peg$e186 = peg$literalExpectation("&&", false);
  const peg$e187 = peg$otherExpectation("multi-line comment");
  const peg$e188 = peg$literalExpectation("/*", false);
  const peg$e189 = peg$literalExpectation("*/", false);
  const peg$e190 = peg$otherExpectation("/* */ inline comment");
  ...
  function peg$f80(target, cols, vals) {    return { kind: 'values', values: vals };  }
  function peg$f81(target, cols, arr) {    return { kind: 'from', source: 'ARRAY', name: arr };  }
  function peg$f82(target, cols) {    return { kind: 'from', source: 'MEMVAR', name: null };  }
  function peg$f83(target, cols, obj) {    return { kind: 'from', source: 'NAME', name: obj };  }
  function peg$f84(target, cols, sel, unions) {
          const parts = unions ? unions.map(u => ({ all: !!u[3], select: u[5] })) : [];
          return { kind: 'select', select: { core: sel, unions: parts } };
  }
  function peg$f85(target, cols, src) {
  ...
  function peg$f86(varName, init, final, step, body, end) {
  ...
  function peg$f88() {    return node("ExitStatement", {});  }
  function peg$f89() {    return node("ContinueStatement", {});  }
  function peg$f90(kind, name, longName) {    return longName;  }
  function peg$f91(kind, name, nameClause, free, codepage, items) {    return { type: 'columns', items: items };  }
  function peg$f92(kind, name, nameClause, free, codepage, arr) {    return { type: 'fromArray', array: arr };  }
  function peg$f93(kind, name, nameClause, free, codepage, def) {
      const payload = { 
  ...
  function peg$f95(c) {    return { kind: 'column', node: c };  }
  function peg$f96(t) {    return { kind: 'constraint', node: t };  }
  function peg$f97(name, ftype, fsize, nullability, expr, err) {    return { expr, error: err ? err[2] : null };  }
  function peg$f98(name, ftype, fsize, nullability, check, nv) {    return { nextValue: nv ? nv[2] : null, step: (nv && nv[4]) ? nv[4][2] : null };  }
  function peg$f99(name, ftype, fsize, nullability, check, autoinc, d) {    return d;  }
  function peg$f100(name, ftype, fsize, nullability, check, autoinc, def) {    return { primaryKey: true, unique: false, collate: null };  }
  function peg$f101(name, ftype, fsize, nullability, check, autoinc, def, cs) {    return cs;  }
  function peg$f102(name, ftype, fsize, nullability, check, autoinc, def, coll) {    return { primaryKey: false, unique: true, collate: coll ? coll[2] : null };  }
  function peg$f103(name, ftype, fsize, nullability, check, autoinc, def, colkey, tbl, tn) {    return tn;  }
  function peg$f104(name, ftype, fsize, nullability, check, autoinc, def, colkey, tbl, tag) {    return { table: tbl, tag: tag ? tag[2] : null };  }
  function peg$f105(name, ftype, fsize, nullability, check, autoinc, def, colkey, refs, nocp) {
  ...
  function peg$f106(t) {    return t.toUpperCase();  }
  function peg$f107(w, p) {    return { width: w, precision: p };  }
  function peg$f108(w) {    return { width: w, precision: null };  }
  function peg$f109(expr, tag) {    return node('TableConstraint', { kind: 'PRIMARY KEY', expression: expr, tag });  }
  function peg$f110(expr, tag, cs) {    return cs;  }
  function peg$f111(expr, tag, coll) {    return node('TableConstraint', { kind: 'UNIQUE', expression: expr, tag, collate: coll ? coll[2] : null });  }
  function peg$f112(expr, tag, nodup, cs) {    return cs;  }
  function peg$f113(expr, tag, nodup, coll, tbl, rt) {    return rt;  }
  function peg$f114(expr, tag, nodup, coll, tbl, reftag) {    return node('TableConstraint', { kind: 'FOREIGN KEY', expression: expr, tag, nodup: !!nodup, collate: coll ? coll[2] : null, references: { table: tbl, tag: reftag ? reftag[2] : null } });  }
  function peg$f115(expr, err) {    return node('TableConstraint', { kind: 'CHECK', expression: expr, error: err ? err[2] : null });  }
  function peg$f116(tstmts, v) {    return v;  }
  function peg$f117(tstmts, toVar, wexpr) {    return wexpr;  }
  function peg$f118(tstmts, toVar, whenPart, cstmts) {
        return { to: toVar ? toVar[2] : null, when: whenPart ? whenPart[2] : null, body: flatten(cstmts.map(s => s[0])) };
  }
  function peg$f119(tstmts, cpart, texpr) {    return texpr === undefined ? null : texpr;  }
  function peg$f120(tstmts, cpart, tpart) {    return true;  }
  function peg$f121(tstmts, cpart, tpart, exitpart, fstmts) {    return flatten(fstmts.map(s => s[0]));  }
  function peg$f122(tstmts, cpart, tpart, exitpart, fpart) {
  ...
  function peg$f123(setting) {    return node("SetTo", { setting });  }
  function peg$f124(cmd, toPart, argPart, additive, state) {    const argument = toPart ? toPart[2] : (argPart ? argPart[1] : null); const st = state ? state[1] : null; return node("cSetCommand", { command: cmd, argument: argument, state: st ? st.toUpperCase() : null, additive: !!additive });  }
  function peg$f125(inner) {
  ...
  function peg$f126(blank, inPart, nomenu) {
  ...
  function peg$f127(fields, forClause, whileClase, inClause, noOptimize) {
  ...
  function peg$f129(field, value, additive) {
      return { field, value, additive: !!additive };
  }
  function peg$f130(expr, vars) {    return { type: 'VarList', vars };  }
  function peg$f131(expr, arr, indexList) {    return { type: 'ArrayIndexed', array: arr, indexes: indexList };  }
  function peg$f132(expr, arrAssign, rhs) {    return { type: 'ArrayAssign', target: arrAssign, expression: rhs };  }
  function peg$f133(expr, toPart) {
    return node('StoreStatement', { expression: expr, target: toPart });
  }
  function peg$f134(head, tail) {    return [head, ...tail.map(t => t[3])];  }
  function peg$f135(expr) {    return node("ReturnStatement", { argument: expr === undefined ? null : expr });  }
  function peg$f136(name) {    return name;  }
  ...
  function peg$f138(chars) {    return node("StringLiteral", { value: chars.join("") });  }
  function peg$f139(chars) {    return node("StringLiteral", { value: chars.join("") });  }
  function peg$f140() {    return '"';  }
  function peg$f141() {    return text();  }
  function peg$f142() {    return "'";  }
  function peg$f143() {    return text();  }
  function peg$f144(p) {    return p.trim();  }
  function peg$f145(b) {    return node("BooleanLiteral", { value: (b.toUpperCase() === ".T.") });  }
  function peg$f146() {    return node("NullLiteral", { });  }
          ...
          if (s7 !== peg$FAILED) {
            ...
            if (s9 !== peg$FAILED) {
              ...
              if (s11 !== peg$FAILED) {
                ...
                if (s16 !== peg$FAILED) {
                  peg$savedPos = s0;
                  s0 = peg$f86(s3, s7, s11, s13, s15, s16);
                } else {
                  peg$currPos = s0;
                  s0 = peg$FAILED;
                }
      ...
      if (s3 !== peg$FAILED) {
        ...
        if (s5 !== peg$FAILED) {
          ...
          if (s14 !== peg$FAILED) {
            ...
            if (s16 !== peg$FAILED) {
              ...
              if (s18 !== peg$FAILED) {
                s19 = peg$parse_();
                peg$savedPos = s12;
                s12 = peg$f91(s3, s5, s7, s9, s10, s16);
              } else {
                peg$currPos = s12;
                s12 = peg$FAILED;
              }
          ...
          if (s12 === peg$FAILED) {
            ...
            if (s14 !== peg$FAILED) {
              ...
              if (s16 !== peg$FAILED) {
                ...
                if (s18 !== peg$FAILED) {
                  peg$savedPos = s12;
                  s12 = peg$f92(s3, s5, s7, s9, s10, s18);
                } else {
                  peg$currPos = s12;
                  s12 = peg$FAILED;
                }
          ...
          if (s12 !== peg$FAILED) {
            s13 = peg$parse__();
            peg$savedPos = s0;
            s0 = peg$f93(s3, s5, s7, s9, s10, s12);
          } else {
            peg$currPos = s0;
            s0 = peg$FAILED;
          }
      ...
      if (s3 !== peg$FAILED) {
        ...
        if (s10 !== peg$FAILED) {
          ...
          if (s12 !== peg$FAILED) {
            ...
            peg$savedPos = s9;
            s9 = peg$f97(s1, s3, s5, s7, s12, s14);
          } else {
            peg$currPos = s9;
            s9 = peg$FAILED;
          }
        ...
        if (s12 !== peg$FAILED) {
          ...
          peg$savedPos = s11;
          s11 = peg$f98(s1, s3, s5, s7, s9, s14);
        } else {
          peg$currPos = s11;
          s11 = peg$FAILED;
        }
        ...
        if (s14 !== peg$FAILED) {
          ...
          if (s16 !== peg$FAILED) {
            peg$savedPos = s13;
            s13 = peg$f99(s1, s3, s5, s7, s9, s11, s16);
          } else {
            peg$currPos = s13;
            s13 = peg$FAILED;
          }
        ...
        if (s16 !== peg$FAILED) {
          ...
          if (s18 !== peg$FAILED) {
            peg$savedPos = s15;
            s15 = peg$f100(s1, s3, s5, s7, s9, s11, s13);
          } else {
            peg$currPos = s15;
            s15 = peg$FAILED;
          }
        ...
        if (s15 === peg$FAILED) {
          ...
          if (s16 !== peg$FAILED) {
            ...
            if (s19 !== peg$FAILED) {
              ...
              if (s21 !== peg$FAILED) {
                peg$savedPos = s18;
                s18 = peg$f101(s1, s3, s5, s7, s9, s11, s13, s21);
              } else {
                peg$currPos = s18;
                s18 = peg$FAILED;
              }
            ...
            peg$savedPos = s15;
            s15 = peg$f102(s1, s3, s5, s7, s9, s11, s13, s18);
          } else {
            peg$currPos = s15;
            s15 = peg$FAILED;
          }
        ...
        if (s18 !== peg$FAILED) {
          ...
          if (s20 !== peg$FAILED) {
            ...
            if (s23 !== peg$FAILED) {
              ...
              if (s25 !== peg$FAILED) {
                peg$savedPos = s22;
                s22 = peg$f103(s1, s3, s5, s7, s9, s11, s13, s15, s20, s25);
              } else {
                peg$currPos = s22;
                s22 = peg$FAILED;
              }
            ...
            peg$savedPos = s17;
            s17 = peg$f104(s1, s3, s5, s7, s9, s11, s13, s15, s20, s22);
          } else {
            peg$currPos = s17;
            s17 = peg$FAILED;
          }
        ...
        peg$savedPos = s0;
        s0 = peg$f105(s1, s3, s5, s7, s9, s11, s13, s15, s17, s19);
      } else {
        peg$currPos = s0;
        s0 = peg$FAILED;
      }
                  ...
                  if (s15 !== peg$FAILED) {
                    ...
                    if (s17 !== peg$FAILED) {
                      ...
                      if (s20 !== peg$FAILED) {
                        ...
                        if (s22 !== peg$FAILED) {
                          peg$savedPos = s19;
                          s19 = peg$f113(s5, s9, s11, s13, s17, s22);
                        } else {
                          peg$currPos = s19;
                          s19 = peg$FAILED;
                        }
                      ...
                      peg$savedPos = s0;
                      s0 = peg$f114(s5, s9, s11, s13, s17, s19);
                    } else {
                      peg$currPos = s0;
                      s0 = peg$FAILED;
                    }
