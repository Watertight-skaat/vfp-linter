...
function peg$parse(input, options) {
  ...
  const peg$e0 = peg$literalExpectation("LOCAL", true);
  ...
  function peg$f1(statement) {    return statement;  }
  ...
  function peg$f3(name) {    return name.join("");  }
